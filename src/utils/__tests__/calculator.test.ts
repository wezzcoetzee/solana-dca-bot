  ...
  describe("determineBotStatsAsync", () => {
    ...
    test("calculates positive ROI correctly", async () => {
      mockRepo.seedTransactions([
        { date: new Date(), wallet: "wallet1", amount: 100, tokenPrice: 40000, symbol: "BTC" },
        { date: new Date(), wallet: "wallet1", amount: 100, tokenPrice: 45000, symbol: "BTC" },
      ]);
    ...
    test("calculates negative ROI correctly", async () => {
      mockRepo.seedTransactions([
        { date: new Date(), wallet: "wallet1", amount: 100, tokenPrice: 60000, symbol: "BTC" },
      ]);
    ...
    test("only includes transactions for specified wallet", async () => {
      mockRepo.seedTransactions([
        { date: new Date(), wallet: "wallet1", amount: 100, tokenPrice: 40000, symbol: "BTC" },
        { date: new Date(), wallet: "wallet2", amount: 200, tokenPrice: 45000, symbol: "BTC" },
      ]);
    ...
    test("calculates average buy price correctly", async () => {
      mockRepo.seedTransactions([
        { date: new Date(), wallet: "wallet1", amount: 50, tokenPrice: 40000, symbol: "BTC" },
        { date: new Date(), wallet: "wallet1", amount: 50, tokenPrice: 60000, symbol: "BTC" },
      ]);
    ...
    test("handles single transaction", async () => {
      mockRepo.seedTransactions([
        { date: new Date(), wallet: "wallet1", amount: 50, tokenPrice: 45000, symbol: "BTC" },
      ]);
